...
export default function SettingsDialog({ open, onOpenChange }: SettingsDialogProps) {
  ...
  useEffect(() => {
    ...
    const savedSettings = localStorage.getItem("mindbuddy-settings")
    if (savedSettings) {
  ...
  const updateSetting = (key: keyof UserSettings, value: boolean | number) => {
    ...
    localStorage.setItem("mindbuddy-settings", JSON.stringify(newSettings))
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Help improve MindBuddy</p>
                </div>
                <Switch
            ...
            <Button
              ...
              onClick={() => {
                if (confirm("Are you sure you want to clear all your data? This cannot be undone.")) {
                  localStorage.removeItem("mindbuddy-journal")
                  localStorage.removeItem("mindbuddy-settings")
