...
const steps = [
  {
    ...
    description:
      "What you share here stays between you and MindBuddy. Your entries and chats are stored locally unless you choose otherwise.",
    icon: Shield,
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <Card className="w-full max-w-xl glass-strong rounded-2xl p-8">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">Welcome to MindBuddy</p>
        </div>
