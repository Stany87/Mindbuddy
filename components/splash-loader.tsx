...
export default function SplashLoader({ onFinish, durationMs = 2200 }: SplashLoaderProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <Card className="relative w-[320px] h-[320px] glass-strong rounded-2xl overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          ...
          >
            <Brain className="h-12 w-12 text-white drop-shadow-[0_2px_8px_rgba(255,255,255,0.35)]" />
          </div>
          ...
          <div className="mt-8 w-40 h-2 bg-secondary/30 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-primary to-secondary animate-[loading_2.2s_ease-in-out_infinite]" />
          </div>
        </div>
