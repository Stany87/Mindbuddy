        ...
        <div className="space-y-6 p-2">
          ...
          <Card className="glass p-6 text-center bg-gradient-to-r from-purple-500/10 to-blue-500/10">
            ...
            <p className="text-sm leading-relaxed">
              MindBuddy is designed to provide accessible, confidential, and empathetic mental wellness support
          ...
          <Card className="glass p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              MindBuddy was created by a team of students passionate about mental health and technology. We understand
          ...
          <Card className="glass p-4 bg-gradient-to-r from-pink-500/10 to-purple-500/10">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              this project possible. MindBuddy is dedicated to everyone who has struggled with mental health challenges
