  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      content:
        "Hi there! I'm your MindBuddy AI companion. I'm here to listen, support, and help you navigate whatever you're feeling today. What's on your mind?",
      sender: "ai",
      timestamp: new Date(),
    },
  ])
      ...
      <header className="glass border-b border-white/10 p-4">
        <div className="flex items-center gap-4 max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold">MindBuddy AI</h1>
